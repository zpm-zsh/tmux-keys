...
b61541208db7fa7dba42c85224405911_view() {
  ...
  left_status+="#[bg=colour1,fg=colour0,bold] Main #[fg=default,bg=default]"
  left_status+=' '
  create_key 2 "Git functions" '520cf8ae214858229a683e2853e343cc_view' '-v'
  left_status+="#[bg=colour4,fg=colour0,bold] Git functions #[fg=default,bg=default]"
  left_status+=' '
  create_key 3 "NPM functions" 'e3b54fd200a08e098757b4bb10fec678_view' '-v'
  left_status+="#[bg=colour3,fg=colour0,bold] NPM functions #[fg=default,bg=default]"
  left_status+=' '
  create_key 4 "ZPM functions" 'cf2fa0e1a2c6046d54edb86fb8cae4dc_view' '-v'
  left_status+="#[bg=colour5,fg=colour0,bold] ZPM functions #[fg=default,bg=default]"
...
520cf8ae214858229a683e2853e343cc_view() {
  ...
  left_status+="#[bg=colour6,fg=colour0,bold] Menu #[fg=default,bg=default]"
  left_status+=' '
  create_key 2 "Git Status" 'git status' '-s'
  left_status+="#[bg=colour9,fg=colour0,bold] Git Status #[fg=default,bg=default]"
  left_status+=' '
  create_key 3 "Git Branch" 'git branch' '-s'
  left_status+="#[bg=colour6,fg=colour0,bold] Git Branch #[fg=default,bg=default]"
...
e3b54fd200a08e098757b4bb10fec678_view() {
  ...
  create_key 1 "Menu" 'b61541208db7fa7dba42c85224405911_view' '-v'
  left_status+="#[bg=colour4,fg=colour0,bold] Menu #[fg=default,bg=default]"
  left_status+=' '
  ...
  left_status+="#[bg=colour12,fg=colour0,bold] NPM Install #[fg=default,bg=default]"
...
cf2fa0e1a2c6046d54edb86fb8cae4dc_view() {
  ...
  left_status+="#[bg=colour4,fg=colour0,bold] Upgrade Plugins #[fg=default,bg=default]"
  left_status+=' '
  create_key 3 "Clean Cache" 'zpm clean' '-s'
  left_status+="#[bg=colour12,fg=colour0,bold] Clean Cache #[fg=default,bg=default]"
  left_status+=' '
  create_key 4 "Readme" 'zpm readme' '-t'
  left_status+="#[bg=colour14,fg=colour0,bold] Readme #[fg=default,bg=default]"
