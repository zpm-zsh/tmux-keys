...
0bcc70105ad279503e31fe7b3f47b665_view() {
  ...
  left_status+=' '
  create_key 2 "Git Status" 'git status' 'exec' 13 true
  left_status+="#[bg=colour8,fg=colour15,bold] 2 #[bg=colour13,fg=colour0,bold] Git Status #[fg=default,bg=default]"
  left_status+=' '
...
a7f5f35426b927411fc9231b56382173_view() {
  ...
  create_key 1 "Main" 'a02c83a7dbd96295beaefb72c2bee2de_view' 'view' 4 false
  left_status+="#[bg=colour8,fg=colour15,bold] 1 #[bg=colour4,fg=colour0,bold] Main #[fg=default,bg=default]"
  left_status+=' '
  create_key 2 "pip install " 'pip install ' 'insert' 12 true
  left_status+="#[bg=colour8,fg=colour15,bold] 2 #[bg=colour12,fg=colour0,bold] pip install  #[fg=default,bg=default]"
  left_status+=' '
  create_key 3 "Python" '23eeeb4347bdd26bfc6b7ee9a3b755dd_view' 'view' 2 false
  left_status+="#[bg=colour8,fg=colour15,bold] 3 #[bg=colour2,fg=colour0,bold] Python #[fg=default,bg=default]"
...
00a5cdc4be82fd4ba549d52988ef9e14_view() {
  ...
  left_status+=' '
  create_key 2 "NPM list" 'npm ls' 'exec' 2 true
  left_status+="#[bg=colour8,fg=colour15,bold] 2 #[bg=colour2,fg=colour0,bold] NPM list #[fg=default,bg=default]"
  left_status+=' '
  create_key 3 "NPM Install" 'npm i ' 'insert' 4 true
  left_status+="#[bg=colour8,fg=colour15,bold] 3 #[bg=colour4,fg=colour0,bold] NPM Install #[fg=default,bg=default]"
  left_status+=' '
  create_key 4 "Main" 'a02c83a7dbd96295beaefb72c2bee2de_view' 'view' 12 false
  left_status+="#[bg=colour8,fg=colour15,bold] 4 #[bg=colour12,fg=colour0,bold] Main #[fg=default,bg=default]"
...
3517978753cf2043f2a652b3c9d7b524_view() {
  ...
  left_status+="#[bg=colour8,fg=colour15,bold] 1 #[bg=colour9,fg=colour0,bold] Main #[fg=default,bg=default]"
  left_status+=' '
  create_key 2 "Upgrade Plugins" 'zpm upgrade' 'exec' 5 true
  left_status+="#[bg=colour8,fg=colour15,bold] 2 #[bg=colour5,fg=colour0,bold] Upgrade Plugins #[fg=default,bg=default]"
  left_status+=' '
  create_key 3 "Clean Cache" 'zpm clean' 'exec' 3 true
  left_status+="#[bg=colour8,fg=colour15,bold] 3 #[bg=colour3,fg=colour0,bold] Clean Cache #[fg=default,bg=default]"
  left_status+=' '
